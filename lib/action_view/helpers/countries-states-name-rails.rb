module ActionView
	module Helpers
		module CountriesNameHelper
			...
			def CountriesNameHelper.countries
				@@countries
			end
		end

		module USStatesNameHelper
			@@us_states = {
					'AL'=>"Alabama",
					'AK'=>"Alaska",
					'AZ'=>"Arizona",
		...
		module FormOptionsHelper
			include CountriesNameHelper
			include USStatesNameHelper

			def country_name_from_initial( country_initial )
				@@countries[country_initial]
			end

			def us_state_name_from_initial( state_initial )
				@@us_states[state_initial]
			end
